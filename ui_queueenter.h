...
public:
    ...
    void setupUi(QMainWindow *QueueEnter)
    {
        ...
        groupBox->setStyleSheet(QString::fromUtf8("font: 14pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        enterButton = new QPushButton(groupBox);
        enterButton->setObjectName(QString::fromUtf8("enterButton"));
        enterButton->setGeometry(QRect(30, 80, 75, 31));
        EnterLabel = new QLabel(groupBox);
        EnterLabel->setObjectName(QString::fromUtf8("EnterLabel"));
        EnterLabel->setGeometry(QRect(20, 40, 81, 20));
        EnterLabel->setStyleSheet(QString::fromUtf8("font: 12pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        enterLineEdit = new QLineEdit(groupBox);
        enterLineEdit->setObjectName(QString::fromUtf8("enterLineEdit"));
        enterLineEdit->setGeometry(QRect(100, 40, 61, 20));
        OutLabel = new QLabel(groupBox);
        OutLabel->setObjectName(QString::fromUtf8("OutLabel"));
        OutLabel->setGeometry(QRect(210, 40, 81, 21));
        OutLabel->setStyleSheet(QString::fromUtf8("font: 12pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        outLineEdit = new QLineEdit(groupBox);
        outLineEdit->setObjectName(QString::fromUtf8("outLineEdit"));
        outLineEdit->setGeometry(QRect(290, 40, 71, 20));
        outLineEdit->setReadOnly(true);
        outButton = new QPushButton(groupBox);
        outButton->setObjectName(QString::fromUtf8("outButton"));
        outButton->setGeometry(QRect(253, 80, 75, 31));
        ...
        explainButton->setGeometry(QRect(462, 57, 75, 31));
        backButton = new QPushButton(groupBox);
        backButton->setObjectName(QString::fromUtf8("backButton"));
        backButton->setGeometry(QRect(570, 57, 75, 31));
