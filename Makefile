#############################################################################
# Makefile for building: DataStructureTeaching
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 3? 4 11:34:18 2017
# Project:  project1.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release -o Makefile project1.pro
#############################################################################
...
Makefile: project1.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release -o Makefile project1.pro
